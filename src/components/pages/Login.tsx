    ...
    <>
      ...
      <div className="w-full flex relative min-h-[100vh] font-poppins">
        <div className="z-0 w-1/2 h-full bg-[var(--primary-color)] bg-gradient-to-b from-[var(--primary-color)] to-[var(--gradient-color)]">
          <Link to='/'>
            <img
              className="md:w-32 hidden lg:block w-12 md:pt-12 md:pl-12 pl-4 pt-4 object-contain aspect-square cursor-pointer hover:brightness-75 transition duration-300"
              src="icons/logo.png"
              alt=""
            />
          </Link>
