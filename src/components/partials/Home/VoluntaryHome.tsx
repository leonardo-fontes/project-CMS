...
function VoluntaryHome() {
  return (
    <div className="container mx-auto flex flex-col lg:px-48 md:px-12 my-12 lg:my-16 gap-6 md:items-start items-center">
      <h2 className="text-4xl font-bold lg:w-4/5 lg:ml-0 ml-4">Programa de voluntariado da Acesse-me</h2>
      ...
      <Button
        ...
        classname="md:w-72 w-[22rem] bg-white text-[var(--primary-color)] hover:text-[var(--gradient-color)]"
      />
    </div>
  );
}
